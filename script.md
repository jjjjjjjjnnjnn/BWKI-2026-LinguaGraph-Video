# script.md — LinguaGraph Video-Pitch 口播稿 (DE)

> **SSOT**: 本文件 = `nach/docs/narration_de.md`(2026-09-11 不动)
> **下游**: `nach/presentation/src/chapters/01-linguagraph-pitch/narrations.ts` 按 step 切分
> **总字数**: ~570 字 (DE) / 估时 ~203s

---

## S01 — Hook + Team (M1, step 1–5, ~29s)
...
## S05 — Kritische Reflexion (M5, step 24–27, ~25s)
...
## S06 — Anwendung + Schluss (M6, step 28–32, ~32s)
