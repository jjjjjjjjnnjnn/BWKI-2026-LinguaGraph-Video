...
| S04 Befund | 1:47–2:26 | Balken LDS-C vs. Boden (0,93–0,96 vs. 0,85–0,87) → Treiberliste DE vs. ZH → Blender s05_threecities (8s) | 55 Messungen/50 Modelle, p<0,05, kulturell gemustert (Autonomie/Regeln vs. Raum/Anspruch); institutionell konvergiert | `outputs/figures`, Blender s05 |
